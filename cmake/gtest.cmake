...
if(gtest_FOUND AND NOT FORCE_REBUILD_CANN_3RD)
    ...
    set (gtest_CXXFLAGS "-D_GLIBCXX_USE_CXX11_ABI=0 -O2 -D_FORTIFY_SOURCE=2 -fPIC -fstack-protector-all -Wl,-z,relro,-z,now,-z,noexecstack -std=c++11")
    set (gtest_CFLAGS   "-D_GLIBCXX_USE_CXX11_ABI=0 -O2 -D_FORTIFY_SOURCE=2 -fPIC -fstack-protector-all -Wl,-z,relro,-z,now,-z,noexecstack -std=c++11")
    set(GETST_SRC_DIR ${PROJECT_SOURCE_DIR}/third_party/googletest-1.14.0)
    include(ExternalProject)
    ExternalProject_Add(third_party_gtest
            # URL ${REQ_URL}
            # TLS_VERIFY OFF
            # DOWNLOAD_DIR ${CANN_3RD_PKG_PATH}
            SOURCE_DIR ${GETST_SRC_DIR}
