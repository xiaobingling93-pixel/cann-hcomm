...
STATIC void RsUbFreeAsyncEventCb(struct RsUbDevCb *devCb, struct RsCtxAsyncEventCb *asyncEventCb)
{
...
uint8_t RsGetBitmapCount(unsigned int attrBitmap)
{
...
STATIC int RsUbGetJettyCb(struct RsUbDevCb *devCb, unsigned int jettyId, struct RsCtxJettyCb **jettyCb)
{
