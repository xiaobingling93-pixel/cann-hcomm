...
HcclResult AllGatherVMeshAivExecutor::CalBlockDim(u32& blockDim, u32 rankSize, u64 dataSize, HcclCMDType cmdType)
{
    blockDim = rankSize + 1; // 单机场景，单算子AllGather大数据使用(rankSize + 1)个aiv
